...
import { CalendarModalOptions, CalendarModal } from 'src/app/hijrilib';
...
export class HijricalendarPage {
  @ViewChild(CalendarComponent, {static: true}) clndr: CalendarComponent;
